...
pub const OPENMPT_API_VERSION_MINOR: u32 = 5;
pub const OPENMPT_API_VERSION_PATCH: u32 = 7;
...
pub const LIBOPENMPT_DEPRECATED_STRING_CONSTANT: libc::c_int = 0;
extern "C" {
...
extern "C" {
    ...
    pub fn openmpt_free_string(str_: *const libc::c_char);
}
extern "C" {
    ...
    pub fn openmpt_get_string(key: *const libc::c_char) -> *const libc::c_char;
}
extern "C" {
    ...
    pub fn openmpt_get_supported_extensions() -> *const libc::c_char;
}
extern "C" {
    ...
    pub fn openmpt_is_extension_supported(extension: *const libc::c_char) -> libc::c_int;
}
...
pub type openmpt_stream_read_func = ::core::option::Option<
    unsafe extern "C" fn(
...
pub type openmpt_stream_seek_func = ::core::option::Option<
    unsafe extern "C" fn(
        stream: *mut libc::c_void,
        offset: i64,
        whence: libc::c_int,
...
fn bindgen_test_layout_openmpt_stream_callbacks() {
    assert_eq!(
        ::core::mem::size_of::<openmpt_stream_callbacks>(),
        24usize,
        concat!("Size of: ", stringify!(openmpt_stream_callbacks))
    );
    assert_eq!(
        ::core::mem::align_of::<openmpt_stream_callbacks>(),
        8usize,
        concat!("Alignment of ", stringify!(openmpt_stream_callbacks))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<openmpt_stream_callbacks>())).read as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<openmpt_stream_callbacks>())).seek as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(openmpt_stream_callbacks),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<openmpt_stream_callbacks>())).tell as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(openmpt_stream_callbacks),
...
pub type openmpt_log_func = ::core::option::Option<
    unsafe extern "C" fn(message: *const libc::c_char, user: *mut libc::c_void),
>;
extern "C" {
    #[doc = " \\brief Default logging function"]
    #[doc = ""]
    #[doc = " Default logging function that logs anything to stderr."]
    pub fn openmpt_log_func_default(message: *const libc::c_char, user: *mut libc::c_void);
}
extern "C" {
    #[doc = " \\brief Silent logging function"]
    #[doc = ""]
    #[doc = " Silent logging function that throws any log message away."]
    pub fn openmpt_log_func_silent(message: *const libc::c_char, user: *mut libc::c_void);
}
extern "C" {
    ...
    #[doc = " \\since 0.3.0"]
    pub fn openmpt_error_is_transient(error: libc::c_int) -> libc::c_int;
}
extern "C" {
    ...
    #[doc = " \\since 0.3.0"]
    pub fn openmpt_error_string(error: libc::c_int) -> *const libc::c_char;
}
...
#[doc = " \\since 0.3.0"]
pub type openmpt_error_func = ::core::option::Option<
    unsafe extern "C" fn(error: libc::c_int, user: *mut libc::c_void) -> libc::c_int,
>;
extern "C" {
    ...
    #[doc = " \\since 0.3.0"]
    pub fn openmpt_error_func_default(error: libc::c_int, user: *mut libc::c_void) -> libc::c_int;
}
extern "C" {
    ...
    #[doc = " \\since 0.3.0"]
    pub fn openmpt_error_func_log(error: libc::c_int, user: *mut libc::c_void) -> libc::c_int;
}
extern "C" {
    ...
    #[doc = " \\since 0.3.0"]
    pub fn openmpt_error_func_store(error: libc::c_int, user: *mut libc::c_void) -> libc::c_int;
}
extern "C" {
    ...
    #[doc = " \\since 0.3.0"]
    pub fn openmpt_error_func_ignore(error: libc::c_int, user: *mut libc::c_void) -> libc::c_int;
}
extern "C" {
    ...
    #[doc = " \\since 0.3.0"]
    pub fn openmpt_error_func_errno(error: libc::c_int, user: *mut libc::c_void) -> libc::c_int;
}
extern "C" {
    ...
    #[doc = " \\since 0.3.0"]
    pub fn openmpt_error_func_errno_userdata(error: *mut libc::c_int) -> *mut libc::c_void;
}
extern "C" {
...
extern "C" {
    ...
    pub fn openmpt_could_open_probability2(
        ...
        effort: f64,
        logfunc: openmpt_log_func,
        loguser: *mut libc::c_void,
        errfunc: openmpt_error_func,
        erruser: *mut libc::c_void,
        error: *mut libc::c_int,
        error_message: *mut *const libc::c_char,
    ) -> f64;
}
extern "C" {
    ...
    #[doc = " \\sa openmpt_probe_file_header_without_filesize()"]
    #[doc = " \\since 0.3.0"]
    pub fn openmpt_probe_file_header_get_recommended_size() -> size_t;
}
extern "C" {
...
pub struct openmpt_module_initial_ctl {
    pub ctl: *const libc::c_char,
    pub value: *const libc::c_char,
}
#[test]
fn bindgen_test_layout_openmpt_module_initial_ctl() {
    assert_eq!(
        ::core::mem::size_of::<openmpt_module_initial_ctl>(),
        16usize,
        concat!("Size of: ", stringify!(openmpt_module_initial_ctl))
    );
    assert_eq!(
        ::core::mem::align_of::<openmpt_module_initial_ctl>(),
        8usize,
        concat!("Alignment of ", stringify!(openmpt_module_initial_ctl))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<openmpt_module_initial_ctl>())).ctl as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<openmpt_module_initial_ctl>())).value as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
...
extern "C" {
    ...
    #[doc = " \\since 0.3.0"]
    pub fn openmpt_module_error_get_last(mod_: *mut openmpt_module) -> libc::c_int;
}
extern "C" {
    ...
    #[doc = " \\sa openmpt_module_error_clear"]
    #[doc = " \\since 0.3.0"]
    pub fn openmpt_module_error_get_last_message(mod_: *mut openmpt_module) -> *const libc::c_char;
}
extern "C" {
    ...
    #[doc = " \\sa openmpt_module_error_clear"]
    #[doc = " \\since 0.3.0"]
    pub fn openmpt_module_error_set_last(mod_: *mut openmpt_module, error: libc::c_int);
}
extern "C" {
...
extern "C" {
    ...
    pub fn openmpt_module_select_subsong(mod_: *mut openmpt_module, subsong: i32) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    ...
    pub fn openmpt_module_get_metadata_keys(mod_: *mut openmpt_module) -> *const libc::c_char;
}
extern "C" {
    ...
    #[doc = "          Possible keys are:"]
    #[doc = "          - type: Module format extension (e.g. it)"]
...
extern "C" {
    ...
    pub fn openmpt_module_get_ctls(mod_: *mut openmpt_module) -> *const libc::c_char;
}
extern "C" {
